export default {
  ...
  Goya: {
    ...
    exploreh2: "Explore!",
    exploreli1:
      "What is your favorite and least favorite part of the Duchess’s outfit?",
  ...
  Kahlo: {
    ...
    funfacts: "Fun Facts!",
    funfactsli1:
      "Frida owned the following pets: chickens, sparrows, macaws and parakeets, Bonito the parrot, a fawn named Granizo, spider monkeys Fulang Chang and Caimito de Guayabal, the empirically-named eagle Gertrudis Caca Blanca, and hairless Xoloitzcuintli dogs with ancient Aztec lineage.",
    funfactsli2:
      "Frida and Diego lived in the famous Casa Azul designed by  architect Juan O’Gorman. The compound has two houses, one white and one blue, joined by a bridge.",
    funfactsli3:
      " Kahlo wore traditional Tehuana dress to show alliance to indigenous citizens who were discriminated against. This style included her iconic full skirts, embroidered blouses and regal coiffure associated with a matriarchal society from the Isthmus of Tehuantepec in Oaxaca, Mexico.",
    exploreh2: "Explore!",
    exploreli1:
      "Why do you think Frida painted herself with her parrots? If you could be painted with an animal, which one would you choose?",
  },
  // Krater
  Krater: {
    arrow: "Keep Exploring",
    title:
      "Terracotta column-krater (bowl for mixing wine and water), <i>ca. 470–460 B.C.</i>",
    artist: "Attributed to the Orchard Painter",
    description:
      "This Kratar shows the story of Jacob and the Golden Fleece:<br/></br>Jason led the Argonauts, a band of adventurers who set out on the ship Argo to steal the magical golden fleece of a ram, which was preserved in Kolchis on the Black Sea. With the help of the gods and the sorceress Medea, Jason was able to take the fleece from a grove protected by a dragon. Here, with Athena beside him, he reaches for the fleece. A companion prepares to board the ship.<br/></br>The basis of the legend of the Golden Fleece is probably the ancient practice of extracting alluvial gold by causing the deposits in a stream to wash over a fleece, thereby catching the gold-bearing material in the curly pelt.",
    funfacts: "Fun Facts!",
    funfactsli1:
      "Pottery was used to tell myths that were told by Greek poets.",
    exploreh2: "Explore!",
    exploreli1:
      "Describe what you see on the krater. Can you identify the characters?",
  },
  // Ono
  Ono: {
    arrow: "Keep Exploring",
    ...
    exploreh2: "Explore!",
    exploreli1:
      "Use your imagination to carry out the piece. What does your garden look like with the clouds?",
